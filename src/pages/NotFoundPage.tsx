  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f7f8fa] dark:bg-[#0b1020] p-6 text-center">
      <div className="relative">
         ...
         <div className="w-24 h-24 bg-red-100 dark:bg-red-500/10 border border-red-500/20 rounded-2xl flex items-center justify-center mb-8 relative z-10 shadow-xl shadow-red-500/10">
           <AlertTriangle className="w-12 h-12 text-red-500" />
         </div>
      </div>
      <h1 className="text-5xl md:text-8xl font-medium text-slate-900 dark:text-white mb-4 tracking-tight">404</h1>
